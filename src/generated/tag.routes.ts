...
const WRITABLE_SCALAR_FIELDS = ["name", "color", "taskId"] as const
const RELATION_FIELDS = ["task"] as const
...
export function createTagRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Tag not found" } }, 404)
      }
