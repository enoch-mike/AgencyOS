...
/**
 * Hooks for ActivityLog routes
 */
export interface ActivityLogHooks {
  /**
...
/**
 * Default ActivityLog hooks (customize as needed)
 */
export const activityLogHooks: ActivityLogHooks = {
