...
const WRITABLE_SCALAR_FIELDS = ["name", "email", "phone", "role", "isPrimary", "createdAt", "clientId"] as const
const RELATION_FIELDS = ["client"] as const
...
export function createContactRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Contact not found" } }, 404)
      }
