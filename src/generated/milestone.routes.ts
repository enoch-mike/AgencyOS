...
/**
 * Auto-generated Milestone Routes
 *
...
import type { MilestoneHooks } from "./milestone.hooks"
...
/**
 * Set hooks for Milestone routes
 */
export function setMilestoneHooks(h: MilestoneHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["name", "dueDate", "completed", "createdAt", "projectId"] as const
const RELATION_FIELDS = ["project"] as const
...
/**
 * Create Milestone CRUD routes
 */
export function createMilestoneRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Milestone not found" } }, 404)
      }
