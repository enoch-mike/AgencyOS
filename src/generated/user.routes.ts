...
const WRITABLE_SCALAR_FIELDS = ["email", "password", "name", "avatar", "role", "plan", "stripeCustomerId", "subscriptionStatus", "subscriptionEndsAt", "createdAt", "updatedAt"] as const
const RELATION_FIELDS = ["clients", "projects", "tasks", "meetings", "activityLogs"] as const
